...
export default function SQLiteIcon({width, height, className}: SVGAttributes<SVGSVGElement>) {
    return (
        <svg
            viewBox="0 0 32 32"
            width={width}
        ...
        >
            ...
            <g id="SVGRepo_iconCarrier">
                ...
                <path d="M23.192,3.242H5.623A2.147,2.147,0,0,0,3.482,5.383V24.759A2.147,2.147,0,0,0,5.623,26.9H17.195C17.063,21.142,19.03,9.968,23.192,3.242Z" style={{fill:"#0f80cc"}}></path>
                <path d="M22.554,3.867H5.623A1.518,1.518,0,0,0,4.107,5.383V23.345a42.01,42.01,0,0,1,13.569-2.684A123.555,123.555,0,0,1,22.554,3.867Z" style={{fill:"url(#a)"}}></path>
