...
export default function SwaggerIcon({width, height, className}: SVGAttributes<SVGSVGElement>) {
    return (
        <svg
            viewBox="0 0 32 32"
        ...
        >
            ...
            <g id="SVGRepo_iconCarrier">
                ...
                <path d="M30,16a14,14,0,1,1-4.1-9.9A13.956,13.956,0,0,1,30,16Z" style={{fill:"#fff"}}></path>
                <path d="M27.9,16a11.9,11.9,0,1,1-3.485-8.415A11.863,11.863,0,0,1,27.9,16Z" style={{fill:"#6d9a00"}}></path>
                <path d="M11.66,15.983a.938.938,0,0,1,.977-.976.976.976,0,1,1-.977.976Z" style={{fill:"#fff"}}></path>
                <path d="M15.031,15.983a.938.938,0,0,1,.977-.976.976.976,0,1,1-.977.976Z" style={{fill:"#fff"}}></path>
                <path d="M18.4,15.983a.938.938,0,0,1,.977-.976.976.976,0,1,1-.977.976Z" style={{fill:"#fff"}}></path>
