...
export default function TypeScriptIcon({width, height, className}: SVGAttributes<SVGSVGElement>) {
    return (
        <svg viewBox="0 0 32 32" xmlns="http://www.w3.org/2000/svg" fill="#000000" width={width} height={height} className={className}>
